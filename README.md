...
.monaco-editor, .monaco-diff-editor, .monaco-component {
    ...
    /* --vscode-icon-foreground: #d8e6f3; */
    de-focusBorder: rgba(0, 0, 0, 0);
    ...
    --vscode-sash-hoverBorder: rgba(0, 0, 0, 0);
    --vscode-badge-background: #c4c4c4;
    --vscode-badge-foreground: #333333;
    /* --vscode-scrollbar-shadow: #c7ced5; */
    --vscode-scrollbarSlider-background: rgba(100, 100, 100, 0.4);
    --vscode-scrollbarSlider-hoverBackground: rgba(100, 100, 100, 0.7);
    --vscode-scrollbarSlider-activeBackground: rgba(0, 0, 0, 0.6);
    /* --vscode-progressBar-background: #4183c4; */
    /* --vscode-editor-background: #fafdff; */
    --vscode-editor-foreground: #181c21;
    /* --vscode-editorStickyScroll-background: #fafdff; */
    /* --vscode-editorStickyScrollHover-background: #f0f0f0; */
    /* --vscode-editorStickyScroll-shadow: #c7ced5; */
    ...
    /* --vscode-editor-selectionBackground: #7aa8d6; */
    /* --vscode-editor-selectionForeground: #7aa8d6; */
    /* --vscode-editor-inactiveSelectionBackground: #8db5dc; */
    ...
    --vscode-breadcrumb-background: #fafdff;
    ...
    --vscode-input-foreground: #01050a;
    ...
    --vscode-list-focusOutline: rgba(0, 0, 0, 0);
    ...
    --vscode-editorActionList-background: #ffffff;
    ...
    --vscode-editor-lineHighlightBackground: #d9e6f3;
    ...
    --vscode-editorLineNumber-foreground: #6a7178;
    ...
    --vscode-editorGutter-background: #fafdff;
    ...
    --vscode-actionBar-toggledBackground: rgba(0, 0, 0, 0);
    ...
    --vscode-editor-foldBackground: rgba(122, 168, 214, 0.3);
    ...
    --vscode-editorMarkerNavigation-background: #fafdff;
    --vscode-editorSuggestWidget-background: #ffffff;
    --vscode-editorSuggestWidget-border: #d0d7de;
    --vscode-editorSuggestWidget-foreground: #181c21;
    --vscode-editorSuggestWidget-selectedForeground: #ffffff;
    --vscode-editorSuggestWidget-selectedBackground: #0060c0;
    --vscode-editorSuggestWidget-highlightForeground: #0066bf;
    --vscode-editorSuggestWidget-focusHighlightForeground: #bbe7ff;
    --vscode-editorSuggestWidgetStatus-foreground: rgba(24, 28, 33, 0.5);
    ...
    --vscode-multiDiffEditor-background: #fafdff;
